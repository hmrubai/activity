@extends('layouts.master') @section('content') <div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body"> Entry Daily Activity </div>
                    <table class="table table-striped table-bordered">
                      <thead>
                          <tr>
                              <th colspan="2" style="background: #D4E2F3; text-align:center; font-size:20px">Daily
                                  Activity
                                </th>
                          </tr>
                      </thead>
                      <tbody>
                        <tr>
                            <td class="col-md-12" colspan="2" style="text-align:center; background-color:#eeeeee;">
                                <strong>Visited Information</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control form-control-lg" name="no_of_visited_pharmacy" id="no_of_visited_pharmacy">
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="no_of_identified_not_renewed_license" placeholder="No. of identified not renewed license" class="entryfield form-control">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Description of seized medicine</td>
                            <td>
                                <table border="1" cellpadding="1" cellspacing="1" style="width:800px;">
                                    <tbody>
                                        <tr>
                                            <td><span>Unregistered drug</span></td>
                                            <td><input name="unregistered_drug" class="entrytrueonly" type="checkbox">
                                            </td>
                                            <td><span>Unregistered drug Name</span></td>
                                            <td><input name="unregistered_drug_name" placeholder="Unregistered drug Name" type="text" class="entryfield form-control">
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <table style="width:100%;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                          <input type="number" name="official_no_of_new_drug_licenses_issued" placeholder="No. of new drug licenses issued" class="entryfield form-control">
                                        </td>
                                        <td>No. of drug licenses calncelled</td>
                                        <td>
                                          <input type="number" name="official_no_of_drug_licenses_calncelled" placeholder="No. of drug licenses calncelled" class="entryfield form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                          <input type="number" name="official_no_of_drug_licenses_transfer_out" placeholder="No. of drug licenses Transfer out" class="entryfield form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><b>Total No. of drug license</b></td>
                                        <td colspan="3">
                                          <input type="number" name="official_total_no_of_drug_licenses" placeholder="Total No. of drug license" class="indicator" readonly="readonly">
                                        </td>
                                    </tr>
                                    <tr>
